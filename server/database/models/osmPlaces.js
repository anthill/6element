...
module.exports = {
    ...
    getByIds: function(placeIds){
        return databaseP.then(function (db) {
            ...
            var query = osmPlaces
                .select(osmPlaces.star())
                .from(osmPlaces)
                .where(osmPlaces.id.in(placeIds))
                .toQuery();
    ...
    getByOperator: function(operatorName){
        return databaseP.then(function (db) {
            ...
            var query = osmPlaces
                        .select("*")
                        .from(osmPlaces)
                        .where(osmPlaces.owner.equals(operatorName))
                        .toQuery();
    ...
    getBins: function(pheromonId){
        return databaseP.then(function (db) {
            ...
            var query = osmPlaces
                .select(osmPlaces.bins, osmPlaces.owner)
                .where(osmPlaces.pheromon_id.equals(pheromonId))
                .toQuery();
